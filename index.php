...
<div class="pc-row ">
  ...
  <div class="pc-col-md1 ">
     <h2>
       Code Sack
       <br/> Learn Fast, Build Fast
     </h2>
     <h4>Serach here for code examples, Tutorials,
       <br />Portable library of different periperials like UART, I2C, USB ,Graphical Interface and etc.
       <br />  Learn how to bulid your first to high level RTOS and Linux applications.</h4>
      <p>
        <input type="text" class="search-input" placeholder="Ex : Atmega 8 " id="search-input" name ="Search"/>
      </p>
  </div>

  <div class="pc-col-md2">
          <img src="icons/abc11.png"/>
  </div>
</div>
